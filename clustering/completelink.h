...
#ifndef completelink_H
#define completelink_H
...
class completelink
{
	public:
        ...
        // class constructor
		completelink(std::string datasetName, std::string fileResultName,
                   t_similarities sim, int k);
		completelink();
		completelink(std::string datasetName, std::string fileResultName, t_similarities sim, std::string parametes);
		completelink(std::string parametes);
		// class destructor
		//~completelink();
		completelink(const completelink &a);
		completelink & operator = (const completelink &a);
