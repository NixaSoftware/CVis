...
# TODO: vamos ter que mudar essa linha e testar com novas partições pra gerar o
# javascript talvez. isso aqui tem que ter relação com as partições que vão ser
# geradas pelos algoritmos do servidor
