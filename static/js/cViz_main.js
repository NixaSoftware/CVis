...
//    console.log(cViz.directory);
    queue()
        ...
        .defer(d3.tsv, cViz.directory + "/result.tsv")
        .defer(cViz.getColumnOrder, cViz.directory + "/objOrderEAC.tsv")
        .defer(cViz.getIdenticalObjs, cViz.directory + "/listsIdenticalObjs.tsv")
        .defer(cViz.getDistinctClusters, cViz.directory + "/listDistinctClusters.tsv")
        .await(ready);
