...
int		iWinner = 0;
	...
	// select solution 1
	//	iSolution1 = randomInt(0, oSolutions.size()); //(int)(((double)rand () / ((double)RAND_MAX + 1.0)) * oSolutions.size());
	iSolution1 = (int)(((double)rand () / ((double)RAND_MAX + 1.0)) * oSolutions.size());
	//std::cout << "solution 1: " << iSolution1 << std::endl;
	
	do 
	{
//		iSolution2 = randomInt(0, oSolutions.size()); //(int)(((double)rand () / ((double)RAND_MAX + 1.0)) * oSolutions.size());
		iSolution2 = (int)(((double)rand () / ((double)RAND_MAX + 1.0)) * oSolutions.size());
 	} 
	while(iSolution1 == iSolution2);
	
    //std::cout << "solution 2: " << iSolution2 << std::endl;
